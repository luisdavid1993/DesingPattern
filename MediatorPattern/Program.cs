/// <summary>
/// BEHAVIORAL
/// Handle all the communication between difference components. Hidden the communication complex
/// </summary>
...
{
    IEnumerable<CustomerBase> Get();
}

internal class CustomerBase
{
}
internal class FactoryDAL<T>
{
    internal static IRepository<CustomerBase> Create(string text)
    {
        throw new NotImplementedException();
    }
}
